export default function Cards() {
  return (
    <div className="w-full flex-col gap-6 text-primary my-24 flex items-center justify-center">
      <div className="flex flex-wrap flex-col gap-6 justify-center items-center">
